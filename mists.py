...
trollCaveRoom = MakeRoom("Troll Cave","Here lies a large troll. You wake him, and he blocks all exits to the room",ChallengeType.Monster)
...
trollCaveRoom21 = MakeRoom("Troll Cave 2.1","Here lies a large troll. You wake him, and he blocks all exits to the room",ChallengeType.Monster)
...
galleryRoom = MakeRoom("Old Gallery", "Strange colorful art covers the walls. The vigor has not drained out of these paintings, and it looks untouched by time",ChallengeType.NoChallenge)
...
AddConnection(trollCaveRoom21,galleryRoom,'e')
...
AddConnection(galleryRoom,pitFall22,'s')
AddConnection(galleryRoom,traproom21,'n')
